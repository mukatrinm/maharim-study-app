      ...
      const built = genTree({
        rows: [
          ...
          [
            ...
            node("intisar", "انتصار", 0, 0, "blocked", "بنت خالدية وفوزي بالرضاع", "صارت بنتاً لخالدية بالرضاع وبنتاً لفوزي بلبن الفحل، فهي أخت عمر بالرضاع لأب — مع أنها لم ترضع من سامية.", { gender: "f" })
          ]
        ],
