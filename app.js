...
const rules = [
  ...
  },
  {
    ...
    examples: [
      ...
      { summary: "الربيبة بالرضاع: زوجتي أرضعت بنتاً صغيرة، فتحرم عليَّ بعد الدخول بزوجتي — كحكم الربيبة في النسب.", scenario: { family: "radaa", label: "الربيبة بالرضاع" } },
  ...
  },
  {
    ...
    examples: [
      { summary: "فوزي، سامية، خالدية: انتصار رضعت من خالدية بلبن سببه فوزي، فصارت بنت فوزي بالرضاع، أي أختاً لعمر بالرضاع لأب.", scenario: { family: "radaa", label: "لبن الفحل: فوزي وسامية وخالدية" } },
...
const familyScenarios = {
  ...
  radaa: [
    ...
    scenario("عمر ومحمود وبنات المرضعة", () => ({
      ...
      subtitle: "الرضاع يثبت لمن رضع فعلاً، لا لإخوته بالنسب",
      toggle: null,
      nodes: [
        node("nurse", "المرضعة\n(ليست أم عمر\nبالنسب)", 470, 95, "blocked", "أم عمر بالرضاع", "امرأة من خارج العائلة، أرضعت عمر صغيراً فصارت أمه بالرضاع.", { gender: "f" }),
        node("girls", "بنات\nالمرضعة\nمن نسبها", 250, 285, "blocked", "أخوات عمر بالرضاع", "هن بنات المرضعة من نسبها (لم يرضعن مع عمر، لكن أمهن صارت أم عمر بالرضاع). فهنّ أخوات لعمر بالرضاع، ولسن أخوات لمحمود لأنه لم يرضع من المرضعة.", { gender: "f" }),
        node("omar", "عمر\nرضع من\nالمرضعة", 470, 455, "neutral", "الرضيع", "عمر هو الذي رضع، فالعلاقة بالرضاع تثبت له فقط.", { gender: "m" }),
        node("mahmoud", "محمود\nأخو عمر بالنسب\n(لم يرضع)", 700, 455, "neutral", "أخ عمر نسباً", "محمود أخو عمر بالنسب، لكنه لم يرضع من هذه المرأة. فلا تثبت له صلة رضاع بها أو ببناتها، ويجوز له الزواج منهن.", { gender: "m" })
      ],
      edges: [
    ...
    scenario("خالد، سعاد، سهام", () => {
      const built = genTree({
        rows: [
          [
            node("suad", "سعاد\nأرضعت بسبب\nالحمل من خالد", 0, 0, "blocked", "الأم بالرضاع", "سعاد درَّت اللبن لأنها حملت من خالد، ثم أرضعت عمر — فصارت أمه بالرضاع. (عمر ليس ابنها بالنسب).", { gender: "f" }),
            node("khaled", "خالد\nصاحب اللبن", 0, 0, "blocked", "الأب بالرضاع (الفحل)", "خالد زوج كل من سعاد وسهام. اللبن الذي رضع منه عمر سببه حمل سعاد من خالد، فهو لبن الفحل، وبذلك صار خالد أبا عمر بالرضاع.", { gender: "m" }),
            node("siham", "سهام\nالزوجة الأخرى\nلخالد", 0, 0, "blocked", "زوجة أب عمر بالرضاع", "سهام لم ترضع عمر، لكن لمَّا صار خالد أبا عمر بالرضاع، صارت سهام (زوجته الأخرى) زوجة أب عمر بالرضاع، فتحرم عليه.", { gender: "f" })
          ],
          [
            node("omar", "عمر\n(ليس ابنهما\nبالنسب)", 0, 0, "neutral", "الرضيع", "عمر من نسب آخر، لكنه رضع من سعاد بلبن سببه خالد. فأصبح ابن سعاد بالرضاع وابن خالد بالرضاع (لبن الفحل).", { gender: "m" })
          ]
        ],
    ...
    scenario("سهام وختام", () => {
      const built = genTree({
        rows: [
          [
            node("khitam", "ختام\n(ليست أم سهام\nبالنسب)", 0, 0, "blocked", "أم الزوجة بالرضاع", "ختام ليست أم سهام بالنسب — فقط أرضعتها وهي صغيرة في الحولين بشروط الرضاع المحرم. فصارت أم زوجة عمر بالرضاع وتحرم عليه مؤبداً.", { gender: "f" })
          ],
          [
            node("omar", "عمر\nالزوج", 0, 0, "neutral", "الزوج", "عمر تزوج سهام بعد أن كبرت.", { gender: "m" }),
            node("siham", "سهام\nالزوجة", 0, 0, "neutral", "الزوجة", "سهام رضعت صغيرة من ختام (في الحولين)، ثم تزوجها عمر بعد ذلك.", { gender: "f" })
          ]
        ],
    ...
    scenario("أختي أرضعت بنتاً", () => ({
      ...
      subtitle: "إذا أرضعت أختك بنتاً (ليست من نسبها)، تصير بنت أختك بالرضاع",
      toggle: null,
      nodes: [
        node("self", "أنت", 470, 300, "neutral", "محور المثال", "أختك أرضعت بنتاً ليست من نسبها (بنت رضاع لها فقط).", { gender: "m" }),
        node("sister", "أختك", 470, 115, "blocked", "الأخت", "الأخت محرمة بالنسب، وكل من رضع منها يصير ولدها بالرضاع.", { gender: "f" }),
        node("girl", "البنت\nالمرتضعة\n(ليست بنت أختك\nبالنسب)", 250, 300, "blocked", "بنت الأخت بالرضاع", "بنت من نسب آخر، رضعت من أختك بشروط الرضاع المحرم. فصارت بنتها بالرضاع، وبنت أختك بالنسبة لك.", { gender: "f" }),
        node("role", "أنت\nخالها بالرضاع", 700, 300, "neutral", "صلة الرضاع", "تأخذ البنت حكم بنت الأخت في النسب: أنت خالها بالرضاع، وهي محرمة عليك.", { shape: "rule" })
      ],
      edges: [
        edge("self", "sister", { label: "أخ/أخت بالنسب" }),
        edge("sister", "girl", { label: "أرضعتها" }),
        edge("self", "girl", { status: "blocked", label: "بنت الأخت بالرضاع", curve: -70 }),
        edge("self", "role", { label: "خال" })
      ]
    })),
    scenario("الربيبة بالرضاع", (condition) => {
      const built = genTree({
        rows: [
          [
            node("husband", "الزوج\n(أنا)", 0, 0, "neutral", "الزوج", "أتزوج ليلى. السؤال: هل تحرم عليَّ فاطمة (التي أرضعتها ليلى)؟", { gender: "m" }),
            node("layla", "ليلى\nالزوجة", 0, 0, "neutral", "الزوجة المرضعة", "ليلى زوجتي. أرضعت فاطمة وهي صغيرة في الحولين، فصارت فاطمة بنتها بالرضاع.", { gender: "f" })
          ],
          [
            node("fatima", "فاطمة\n(ليست بنت\nليلى بالنسب)", 0, 0, condition ? "blocked" : "allowed", "ربيبة بالرضاع", condition ? "بعد دخولي بليلى، فاطمة (ربيبتي بالرضاع) تحرم عليَّ مؤبداً — كحكم الربيبة في النسب." : "إذا فارقت ليلى قبل الدخول بها، فاطمة لا تحرم — لأن الربيبة (نسباً أو رضاعاً) لا تحرم إلا بالدخول بأمها.", { gender: "f" })
          ]
        ],
        marriages: [["husband", "layla"]],
        parents: [
          { id: "fatima", parents: ["layla"] }
        ],
        colWidth: 240
      });
      return {
        title: "مثال: الربيبة بالرضاع",
        subtitle: "ما تحرّم به البنت بالنسب يحرّمها بالرضاع — الدخول بالأم شرط",
        toggle: { label: "حصل الدخول بليلى" },
        nodes: built.nodes,
        edges: [
          ...built.extraEdges,
          edge("husband", "fatima", { status: condition ? "blocked" : "allowed", label: condition ? "ربيبة بالرضاع (تحرم)" : "يجوز", curve: -45 })
        ]
      };
    }),
    scenario("لبن الفحل: فوزي وسامية وخالدية", () => {
      const built = genTree({
        rows: [
          [
            node("samia", "سامية\nأم عمر بالنسب", 0, 0, "neutral", "الزوجة الأولى", "سامية أرضعت عمر فصارت أمه بالرضاع — وهي في الأصل أمه بالنسب.", { gender: "f" }),
            node("fawzi", "فوزي\nصاحب اللبن", 0, 0, "blocked", "صاحب اللبن (الفحل)", "فوزي زوج كل من سامية وخالدية. كلتاهما درَّت اللبن بسبب الحمل منه، فاللبن منسوب إليه (لبن الفحل).", { gender: "m" }),
            node("khaldiya", "خالدية\nأرضعت بسبب\nالحمل من فوزي", 0, 0, "neutral", "الزوجة الثانية / المرضعة", "خالدية درَّت اللبن لأنها حملت من فوزي، ثم أرضعت انتصار. فاللبن نُسِبَ لفوزي (لبن الفحل).", { gender: "f" })
          ],
          [
            node("omar", "عمر\nابن سامية بالنسب", 0, 0, "neutral", "ابن سامية وفوزي بالنسب", "عمر ابن سامية وفوزي بالنسب. لم يرضع من خالدية أصلاً.", { gender: "m" }),
            node("intisar", "انتصار\n(ليست بنت\nخالدية بالنسب)", 0, 0, "blocked", "بنت بالرضاع لخالدية وفوزي", "انتصار من نسب آخر، لكنها رضعت من خالدية. فصارت بنت خالدية بالرضاع، وبنت فوزي بلبن الفحل — وبذلك هي أخت عمر بالرضاع لأب، مع أنها لم ترضع من أمه سامية.", { gender: "f" })
          ]
        ],
      ...
      return {
        ...
        edges: [
          ...built.extraEdges,
          edge("omar", "intisar", { status: "blocked", label: "أخت بالرضاع لأب (تحرم)", curve: 30 })
        ]
      };
    }),
    scenario("لبن الهرمونات", () => ({
      ...
      toggle: null,
      nodes: [
        node("child", "الطفل\nرضع من\nالمرأة", 470, 455, "neutral", "الرضيع", "رضع من امرأة كان لبنها بسبب هرمونات، لا بسبب حمل من زوج.", { gender: "m" }),
        node("woman", "المرأة\n(لبن بسبب\nهرمونات لا حمل)", 470, 250, "blocked", "أم بالرضاع", "تصير أماً للطفل بالرضاع لأنها أرضعته فعلاً، حتى لو كان مصدر اللبن هرمونات.", { gender: "f" }),
        node("husband", "زوجها\n(ليس سبب\nاللبن)", 700, 250, "allowed", "ليس أباً بالرضاع", "اللبن لم يثُر بسبب حمل منه، فلا تثبت له أبوّة بالرضاع للطفل (شرط لبن الفحل غير متحقق).", { gender: "m" }),
        node("daughter", "بنت\nرضعتها قبلاً", 250, 250, "blocked", "صلة الرضاع", "كل من رضع من هذه المرأة تثبت بينه وبين الطفل أخوة بالرضاع.", { gender: "f" }),
        node("rule", "لا لبن\nفحل", 470, 90, "neutral", "قاعدة المثال", "الأبوة بالرضاع تثبت للزوج فقط إذا كان اللبن ثار بسببه (حمل منه). هرمونات بدون حمل لا تنسب الأبوة لأحد.", { shape: "rule" })
      ],
      edges: [
...
const comparisons = [
  {
    ...
    rows: [
      { madhab: "shafii", cells: ["الشافعية", "❌ لا تثبت", "لا يحرم على الزاني الزواج بأم المزني بها أو ابنتها."] },
      { madhab: "maliki", cells: ["المالكية", "❌ لا تثبت", "موافقون للشافعية في عدم ثبوت حرمة المصاهرة بالزنا."] },
